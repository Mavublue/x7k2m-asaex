...
const styles = StyleSheet.create({
  ...
  bdItem: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: Radius.lg, padding: Spacing.md, borderWidth: 1, borderColor: 'transparent' },
  bdItemYeni: { backgroundColor: 'rgba(255,255,255,0.06)', borderColor: 'rgba(255,255,255,0.85)' },
