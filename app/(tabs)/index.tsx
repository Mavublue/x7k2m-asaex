...
const styles = StyleSheet.create({
  ...
  bdItem: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: Colors.surfaceContainerLow, borderRadius: Radius.lg, padding: Spacing.md, borderWidth: 1, borderColor: 'transparent', opacity: 0.5 },
  bdItemYeni: { backgroundColor: 'rgba(255,255,255,0.12)', borderColor: Colors.primary, opacity: 1 },
