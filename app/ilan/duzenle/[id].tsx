          ...
          <View style={styles.modalBox}>
            ...
            <View style={styles.chipRow}>
              {filterKatSayilari(bulunduguKat).map(k => (
                <TouchableOpacity key={k} style={[styles.chip, katSayisi === k && styles.chipActive]} onPress={() => {
          ...
          <View style={styles.modalBox}>
            ...
            <View style={styles.chipRow}>
              {filterBulunduguKatlar(katSayisi).map(k => (
                <TouchableOpacity key={k} style={[styles.chip, bulunduguKat === k && styles.chipActive]} onPress={() => {
...
const styles = StyleSheet.create({
  ...
  inputPrefix: { fontSize: 16, color: Colors.onSurfaceVariant, marginRight: 6 },
  satir: { flexDirection: 'row', gap: Spacing.sm },
  selectBtn: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.surfaceContainerLow, borderRadius: Radius.md, paddingHorizontal: Spacing.md, paddingVertical: 8 },
  ...
  chip: { borderRadius: Radius.full, paddingHorizontal: 10, paddingVertical: 5, backgroundColor: Colors.surfaceContainerLow },
  ...
  mapPickerBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: Colors.surfaceContainerLow, borderRadius: Radius.md, paddingHorizontal: Spacing.md, paddingVertical: 10 },
  mapPickerText: { flex: 1, fontSize: 13, color: Colors.onSurface },
  kaydetBtn: { backgroundColor: Colors.primary, borderRadius: Radius.full, paddingVertical: 11, alignItems: 'center', marginTop: Spacing.sm },
