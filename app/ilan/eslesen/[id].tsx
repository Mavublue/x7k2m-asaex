    ...
    (async () => {
      ...
      const [{ data: ilanData }, { data: tumMusteriler }] = await Promise.all([
        ...
        supabase.from('musteriler')
          .select('id, ad, soyad, telefon, durum, etiketler, musteri_tipi, musteri_istekler(tip, satilik_kiralik, butce_min, butce_max, tercih_konum, min_oda, bina_yasi, kat_sayisi, bulundugu_kat, musteri_istek_ozellikler(ozellik_id))')
...
const s = StyleSheet.create({
  ...
  tipTagText: { fontSize: 11, fontWeight: '600', color: '#60a5fa' },
  ...
  butceTag: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 999, backgroundColor: 'rgba(249,115,22,0.18)' },
  butceTagText: { fontSize: 11, fontWeight: '600', color: '#fdba74' },
  odaTag: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 999, backgroundColor: 'rgba(124,58,237,0.08)' },
  odaTagText: { fontSize: 11, fontWeight: '600', color: '#c4b5fd' },
  yasTag: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 999, backgroundColor: 'rgba(245,158,11,0.1)' },
  yasTagText: { fontSize: 11, fontWeight: '600', color: '#fcd34d' },
  ...
  istekKart: { backgroundColor: Colors.surfaceContainerLow, borderWidth: 1, borderColor: Colors.outlineVariant, borderLeftWidth: 3, borderLeftColor: '#E53935', borderRadius: 10, padding: 12, marginBottom: 8 },
  istekNo: { paddingHorizontal: 6, paddingVertical: 2, backgroundColor: '#E53935', borderRadius: 999 },
  notKart: { backgroundColor: 'rgba(234,179,8,0.10)', borderWidth: 1, borderColor: 'rgba(234,179,8,0.4)', borderRadius: 8, padding: 12, marginBottom: 6 },
  notTarih: { fontSize: 11, fontWeight: '600', color: '#fcd34d', marginBottom: 4 },
  notIcerik: { fontSize: 13, color: '#fde68a', lineHeight: 20 },
});
