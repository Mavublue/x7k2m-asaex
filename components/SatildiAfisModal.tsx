...
const styles = StyleSheet.create({
  ...
  panel: { backgroundColor: Colors.surfaceContainerLow, borderTopLeftRadius: 20, borderTopRightRadius: 20, height: '92%' },
  ...
  label: { fontSize: 13, fontWeight: '600', color: Colors.onSurface, marginBottom: 8 },
  empty: { padding: 24, backgroundColor: Colors.surface, borderRadius: 8, alignItems: 'center' },
  ...
  input: { borderWidth: 1, borderColor: Colors.outlineVariant, borderRadius: 8, padding: 10, fontSize: 14, color: Colors.onSurface },
  fontChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 9999, borderWidth: 1.5, borderColor: Colors.outlineVariant, backgroundColor: Colors.surfaceContainerLow },
  fontChipAktif: { borderColor: Colors.primary, backgroundColor: 'rgba(0,35,111,0.08)' },
  fontChipText: { fontSize: 12, fontWeight: '600', color: Colors.onSurfaceVariant },
