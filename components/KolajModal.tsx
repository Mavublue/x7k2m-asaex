...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 9999, borderWidth: 1.5, borderColor: Colors.outlineVariant, backgroundColor: Colors.surfaceContainerLow },
  ...
  slotBtn: { width: 36, height: 36, borderRadius: 8, backgroundColor: Colors.outlineVariant, alignItems: 'center', justifyContent: 'center' },
  slotBtnAktif: { backgroundColor: '#E53935' },
  slotBtnDolu: { backgroundColor: '#10b981' },
  slotBtnText: { fontSize: 13, fontWeight: '700', color: Colors.onSurfaceVariant },
  ctrlBtn: { paddingHorizontal: 12, paddingVertical: 8, backgroundColor: Colors.surfaceContainerHigh, borderRadius: 8 },
  ctrlBtnText: { fontSize: 12, fontWeight: '700', color: Colors.onSurface },
